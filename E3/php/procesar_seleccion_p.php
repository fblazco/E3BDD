...
$_SESSION['panoramas_seleccionados'] = $_POST['seleccionados'] ?? [];
?>
...
<div style="margin-top: 1em;">
    <a href="anadir_participantes.php" style="display:inline-block; padding:8px 16px; background:#007bff; color:white; text-decoration:none; border-radius:4px;">
        Confirmar selección
    </a>
</div>
        ...
        <p><a href="show_panoramas.php">Volver a la lista</a></p>
    </div>
</body>
</html>
