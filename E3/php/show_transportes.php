...
$hospedajes = $_SESSION['transportes_disponibles']?? []; 
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <div class="container">
        <h1>Transportes en: <?= htmlspecialchars($ciudad) ?></h1>
...
<tbody>
    <?php foreach ($hospedajes as $index => $fila): ?>
        ...
        <?php if ($esDisponible): ?>
            <form id="form-<?= $index ?>" action="main.php" method="post" style="display:none;">
